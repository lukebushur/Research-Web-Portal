...
router.post('/addMajor', [verifyToken, verifiedValidation], majorsRoutes.addMajors);

//DELETE Route for removing a major(s) to a master list
router.delete('/deleteMajor', [verifyToken, verifiedValidation], majorsRoutes.deleteMajors);

//POST for replacing majors
router.post('/replaceMajors', [verifyToken, verifiedValidation], majorsRoutes.replaceMajors);
