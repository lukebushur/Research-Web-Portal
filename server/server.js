...
// import the routes from their respective files
...
// These statements map the routes to endpoints, each new endpoint needs to be
// unique, i.e. there should not be two app.use() statements with '/api'. 
...
// This is a route to verify the health of the server. It does nothing other
// than return success and can be removed without affecting the server.
